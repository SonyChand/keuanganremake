...
CREATE TABLE IF NOT EXISTS `jurnal_umum` (
  ...
  `nama_pengguna` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
-- Dumping data for table keuanganremake.jurnal_umum: ~4 rows (approximately)
REPLACE INTO `jurnal_umum` (`id`, `tanggal`, `nama_pengguna`, `keterangan`, `debet`, `kredit`) VALUES
	(1, 1723222800, 'Putri aulia', 'untuk jurnal', 300000000.00, 8900000.00),
	(2, 1723654800, 'Disnaker Tasikmalaya', 'bebas', 1231.00, 434343.00),
	(3, 1723654800, 'Disnaker Tasikmalaya', 'bebas', 1231.00, 434231231.00),
	(4, 1723654800, 'Disnaker Tasikmalaya', 'bebasss', 1231.00, 434231231.00);
...
REPLACE INTO `menu` (`id`, `menu`, `link`, `icon`, `for`, `order`, `status`) VALUES
	...
	(2, 'Admin', 'admin', 'fas fa-id-badge', '1', 2, 1),
...
-- Dumping data for table keuanganremake.pemasukan: ~4 rows (approximately)
...
REPLACE INTO `pengguna` (`id`, `nama`, `email`, `password`, `image`, `role`, `no_hp`, `jenis_kelamin`, `tgl_dibuat`, `terakhir_login`, `status`) VALUES
	(1, 'ALIF ZULFAHMI YUSUF', 'abahdaud@gmail.com', '$2y$10$dXy5ySWJtvxf9yUluodeguV1WReKdM/mTlfYUMLKpul6hroIBIDmO', '1723123871_53df239a7a21e9d3506d8b13384fae2c1723123871.jpg', 1, '081312157307', 'L', 1658915944, 1723296600, 1),
...
REPLACE INTO `submenu` (`id`, `menu_id`, `title`, `url_i`, `url_ii`, `icon`, `status`) VALUES
	...
	(17, 3, 'Pembukuan', 'keuangan/', 'pembukuan', NULL, 1),
	(18, 3, 'Jurnal Umum', 'keuangan/', 'jurnal', NULL, 1);
